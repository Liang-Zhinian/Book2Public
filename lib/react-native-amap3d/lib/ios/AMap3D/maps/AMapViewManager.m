...
@property (nonatomic, strong) AMapView *aMapView;
...
RCT_EXPORT_VIEW_PROPERTY(onReGeocodeSearchCompleteIOS, RCTBubblingEventBlock)

RCT_CUSTOM_VIEW_PROPERTY(language, NSInteger, AMapView) {
...
- (void)onReGeocodeSearchDone:(AMapReGeocodeSearchRequest *)request response:(AMapReGeocodeSearchResponse *)response
{
    if (response.regeocode != nil && _isSearchFromDragging == NO)
    {
        ...
        if (self.aMapView.onReGeocodeSearchCompleteIOS){
           self.aMapView.onReGeocodeSearchCompleteIOS(
                @{
                 @"title": reGeocodeAnnotation.title,
                 @"subtitle": reGeocodeAnnotation.subtitle
                 });
        }
