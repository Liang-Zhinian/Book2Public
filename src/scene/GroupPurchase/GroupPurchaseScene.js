...
import {Button, color, NavigationItem, Separator, SpacingView} from '../../widget'
import {Heading1, Heading2, Heading3, Paragraph} from '../../widget/Text'
import {screen} from '../../common'
import {recommendUrlWithId} from '../../api'
import GroupPurchaseCellBak from "./GroupPurchaseCellBak";
...
class GroupPurchaseScene extends PureComponent<Props, State> {
    ...
    requestRecommend = async () => {
        try {
            ...
            // var dataList = [];
            // for (var i = 0; i < json.data.deals.length; i++) {
            //     var info = json.data.deals[i];
            //     dataList.push(
            //         {
            //             id: info.id,
            //             imageUrl: info.imgurl,
