...
export default class AreaListScene extends Component {
    ...
    componentDidMount(){
        ...
        getArea('region', region_id)
            .then((msg) => {
                console.log(msg);
                this.setState({regionList: DrinkDetailDataUtils.requestAreaData(msg)})
            })
            .catch((e) => {
                console.warn(e)
            });
    ...
    renderList(){
        ...
        let AreaList = regionList.map((item) => {
            ...
            return(
                <View style={styles.container}>
                    <TouchableOpacity
                        activeOpacity={0.8}
                        onPress={() =>{
                            this.props.navigation.navigate('SubregionListScene',{region_id:item.id})
                        }}
                    >
